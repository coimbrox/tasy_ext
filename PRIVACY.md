...
| Configurações da extensão (quais overlays estão ativos, se o registro de processo está ligado) | Lembrar as preferências do usuário entre sessões | `chrome.storage.local` |
